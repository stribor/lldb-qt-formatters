    ...
    if valobj.IsValid():
        ...
        try:
            ...
            if error.Success():
                ...
                print("printableQString returning", content + tooLarge, pointer, length, flush=TRUE)
...
def QStringSummaryProvider(valobj, internal_dict):
    if valobj.IsValid():
        ...
        print("QStringSummaryProvider: ", printable)
...
class QStringFormatter(HiddenMemberProvider):
    ...
    def _update(self):
        ...
        print("QStringFormatter update: ", printable)
        if printable is not None:
